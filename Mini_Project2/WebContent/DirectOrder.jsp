...
<%
	...
	list=(ArrayList<OrderDTO>)request.getAttribute("directlist");
	...
	<div id="content">
		<div id="content-wrap">
			...
			<div>
						...
						<tbody>
							...
							<%
								for(OrderDTO odto: list){
									...
									int sum=odto.getQty()*pdto.getPrice();
							%>
				...
				%>
					<a href="Controller?command=directpay"><button id="btn">구매하기</button></a>
				</div>
			</div>
		</div>
	</div>
