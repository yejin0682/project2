...
<body>
	...
	list=(ArrayList<BoardDTO>)request.getAttribute("searchlist");
	String search=(String)request.getAttribute("search");
	String search_key=(String)request.getAttribute("search_key");
	int pageno=Integer.parseInt(request.getParameter("page"));
	int boardcount=(int)(request.getAttribute("countsearch"));
			...
			<div class="boardList" style="margin-top: 35px;">
				<table border="1">
					...
					%>
						<tr>
							<td><%=bdto.getQbno()%></td>
							<td><a href="Controller?command=showcontent&qbno=<%=bdto.getQbno()%>&level=<%=level%>&ref=<%=ref%>">
					<%
