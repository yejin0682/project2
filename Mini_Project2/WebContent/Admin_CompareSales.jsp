	...
	<div id="content">
		<div id="content-wrap">
			...
			<div class="boardList" style="margin-top: 135px;">
				<form action="Controller?command=compareSales" method="post">
					Date1: <input type="text" id="datepicker1" name="date1"/><br/>
					Date2: <input style="margin-top:15px;" type="text" id="datepicker2" name="date2"/><br/>
